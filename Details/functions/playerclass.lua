...
do
	...
	function _detalhes:GetClassColor(class)
		if self.classe then
			return _unpack(_detalhes.class_colors[self.classe] or default_color)
		elseif _type(class) == "table" and class.classe then
			return _unpack(_detalhes.class_colors[class.classe] or default_color)
		elseif _type(class) == "string" then
			return _unpack(_detalhes.class_colors[class] or default_color)
		else
